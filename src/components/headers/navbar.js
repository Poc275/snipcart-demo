        ...
        return (
            <div>
                <div className="main-navbar">
                    <div id="mainnav" >
                        <div role="button" className="toggle-nav" onClick={this.openNav.bind(this)} onKeyPress={this.openNav.bind(this)} tabIndex={0}>
                            <i className="fa fa-bars sidebar-bar"></i>
                        </div>
                        <ul className="nav-menu" style={this.state.navClose}>
                            <li className="back-btn">
                                <div role="button" className="mobile-back text-right" onClick={this.closeNav.bind(this)} onKeyPress={this.closeNav.bind(this)} tabIndex={0}>
                                    <span>Back</span>
                            ...
                            {/* <li>
                                ...
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.BASE_URL}/left-sidebar/collection`} >{'category_left_sidebar'}</Link></li>
                                    <li><Link to={`${process.env.BASE_URL}/right-sidebar/collection`} >{'category_right_sidebar'}</Link></li>
                                    <li><Link to={`${process.env.BASE_URL}/no-sidebar/collection`} >{'category_no_sidebar'}</Link></li>
